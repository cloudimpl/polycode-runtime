...
// End the request.
func (w *ResponseWriter) End() sdk.ApiResponse {
...
func ConvertToHttpRequest(ctx context.Context, apiReq sdk.ApiRequest) (*http.Request, error) {
	// Build the URL
	url := apiReq.Path
...
func ManualInvokeHandler(handler http.Handler, httpReq *http.Request) sdk.ApiResponse {
